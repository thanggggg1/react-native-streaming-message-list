...
exports.StreamingMessageList = void 0;
var _reactCompilerRuntime = require("react-compiler-runtime");
var _react = require("react");
var _reactNative = require("react-native");
var _list = require("@legendapp/list");
var _usePlaceholderState = require("./hooks/usePlaceholderState.js");
var _useScrollBehavior = require("./hooks/useScrollBehavior.js");
...
const StreamingMessageList = t0 => {
  const $ = (0, _reactCompilerRuntime.c)(94);
  ...
  const prevDataLengthRef = (0, _react.useRef)(0);
  const {
    ...
    paddingTop,
    setContainerPadding
  } = (0, _usePlaceholderState.usePlaceholderState)(config);
  ...
  } = (0, _useScrollBehavior.useScrollBehavior)(t3);
  const publicContext = (0, _react.useContext)(_StreamingMessageListContext.StreamingMessageListPublicContext);
  let t4;
  ...
  if ($[45] !== contentContainerStyle || $[46] !== scrollMetricsRef || $[47] !== setContainerHeight || $[48] !== setContainerPadding || $[49] !== updateScrollMetrics || $[50] !== updateScrollMetricsState) {
    t8 = event => {
      ...
      if (contentContainerStyle) {
        const style = _reactNative.StyleSheet.flatten(contentContainerStyle);
  ...
  if ($[52] !== checkWhitespaceDismissal || $[53] !== debouncedPlaceholderHeight || $[54] !== onScroll || $[55] !== setWhitespacePhase || $[56] !== updateScrollMetrics || $[57] !== updateScrollMetricsState || $[58] !== whitespacePhase) {
    t9 = event_0 => {
      ...
      if (whitespacePhase === "visible_static" || whitespacePhase === "active") {
        const isVisible = (0, _scrollCalculations.isWhitespaceInViewport)({
  ...
  if ($[62] !== ListFooterComponent || $[63] !== debouncedPlaceholderHeight || $[64] !== whitespacePhase) {
    t11 = () => {
      const listFooterComponent = ListFooterComponent ? /*#__PURE__*/(0, _react.isValidElement)(ListFooterComponent) ? ListFooterComponent : /*#__PURE__*/(0, _jsxRuntime.jsx)(ListFooterComponent, {}) : null;
  ...
  if ($[76] !== ListEmptyComponent || $[77] !== ListHeaderComponent || $[78] !== contentContainerStyle || $[79] !== data || $[80] !== handleContentSizeChange || $[81] !== handleEndReached || $[82] !== handleLayout || $[83] !== handleScroll || $[84] !== isStreaming || $[85] !== keyExtractor || $[86] !== listRef || $[87] !== renderItem || $[88] !== restProps || $[89] !== t15) {
    t16 = /*#__PURE__*/(0, _jsxRuntime.jsx)(_list.LegendList, {
      ref: listRef,
      ...restProps,
  ...
  if ($[91] !== internalContextValue || $[92] !== t16) {
    t17 = /*#__PURE__*/(0, _jsxRuntime.jsx)(_StreamingMessageListContext.StreamingMessageListInternalContext.Provider, {
...
exports.StreamingMessageList = StreamingMessageList;
